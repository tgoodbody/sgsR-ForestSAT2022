...
## Forest Carbon Due Diligence {background-image="images/forest.jpg" background-opacity="15%"}
...
-   Onboarding & supporting implementation of efficient analytical pipelines
-   Tech-transfer for industry/government professionals, graduate students
-   Leading workshops on remote sensing data, approaches, technical workflows
...
-   Open-source software development and package maintenance (`sgsR`)
-   Statistical modelling (e.g. timber attribute modelling, classifications)
...
## Languages {background-image="images/forest.jpg" background-opacity="15%"}
...
::: {.fragment .fade-up}
<center>🏆 Best National PhD Thesis (Canadian Remote Sensing Society)</center>
...
::: columns
::: {.column width="50%"}
-   Need data-driven, scalable, representative field inventories

-   Inventories are out-of-date

-   Integrate best-available forest structure data

-   **Reduce sampling intensity, cost**

-   Flexible to user needs

-   International & interdiciplinary collaboration
:::
