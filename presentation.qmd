...
# [🌲🌳 Forest inventories]{style="float:center;text-align:center;"} {background-color="#027eb6"}
...
# [🚩 Sampling]{style="float:center;text-align:center;"} {background-color="#027eb6"}
...
# [🎲📊 Probability-based sampling]{style="float:center;text-align:center;"} {background-color="#027eb6"}
...
# [🛰👩🏻‍💻 Auxiliary data]{style="float:center;text-align:center;"} {background-color="#027eb6"}
...
# [💠🔢 Stratification]{style="float:center;text-align:center;"} {background-color="#027eb6"}
...
# [`sgsR`]{style="float:center;text-align:center;"} {background-color="#027eb6"}
...
# Overview {background-color="#027eb6"}

![](images/flow.png){fig-align="center"}

# [Example 1]{.story} [Stratified sampling constrained by access]{style="float:right;text-align:right;"} {background-color="#027eb6"}
...
# [Example 2]{.story} [Augmenting an `existing` sample]{style="float:right;text-align:right;"} {background-color="#027eb6"}

## Augmenting an `existing` sample {background-color="#027eb6"}
...
# [🤲🤝🙏 Thank you!]{style="float:center;text-align:center;"} {background-color="#027eb6"}
